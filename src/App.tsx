        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute />}>
            <Route element={<AppLayout />}>
              ...
              <Route path="/mosap3pay/ocorrencias" element={<RoleGuard allowedRoles={["admin", "gestor_incentivos"]}><Mosap3PayOcorrencias /></RoleGuard>} />
          ...
          <Route path="/fornecedor" element={<FornecedorLayout />}>
            ...
            <Route path="vendedores" element={<FornecedorVendedores />} />
            <Route path="turnos" element={<FornecedorTurnos />} />
            <Route path="relatorios/vendedores" element={<FornecedorRelatorioVendedores />} />
